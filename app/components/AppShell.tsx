  ...
  return (
    <div class="app-shell">
      <header class="app-header">
        <p id="appHeaderEyebrow" class="app-header-eyebrow">
          こくごアプリ
        </p>
        <h1 id="appHeaderTitle" class="app-header-title">
          かんじれんしゅう
        </h1>
        <p id="appHeaderSubtitle" class="app-header-subtitle">
          がくねんを えらんで かんじを さがそう
        </p>
      </header>

      <div class="app-layout">
        <aside class="sidebar">
          <button id="sidebarToggle" class="sidebar-toggle hidden" type="button">
            ▼ 漢字をえらぶ
          </button>
          ...
          <div id="sidebarContent" class="sidebar-content">
            ...
            <div class="input-section">
              <input id="kanjiInput" type="text" placeholder="漢字" maxLength={1} />
            ...
            <div class="grade-nav">
              <button class="grade-btn" data-grade="1" type="button">
                1年生
              </button>
              <button class="grade-btn" data-grade="2" type="button">
                2年生
              </button>
              <button class="grade-btn" data-grade="3" type="button">
                3年生
              </button>
              <button class="grade-btn" data-grade="4" type="button">
                4年生
              </button>
              <button class="grade-btn" data-grade="5" type="button">
                5年生
              </button>
              <button class="grade-btn" data-grade="6" type="button">
                6年生
              </button>
            </div>
              ...
              <div class="results-primary">
                <div class="section">
                  <div class="mode-header">
                    ...
                    <button id="modeToggleBtn" class="mode-toggle-btn" title="モードきりかえ" type="button">
                      ✏ なぞる
                    </button>
                  </div>
                  ...
                  <div id="traceArea" class="trace-area hidden">
                    ...
                    <div class="trace-info">
                      ...
                      <span id="traceEndingHint" class="trace-ending-hint hidden"></span>
                      <button id="traceRetryBtn" class="trace-retry-btn hidden" type="button">
                        <span class="trace-retry-icon" aria-hidden="true">↺</span>
                        <span>もういちど</span>
                      </button>
                    </div>
